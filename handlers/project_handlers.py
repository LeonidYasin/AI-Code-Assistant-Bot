...
async def register_project_handlers(application, llm_client):
    ...
    try:
        ...
        # Store handlers in bot_data for later use
        ...
        if hasattr(project_handlers, 'test_command'):
            application.add_handler(CommandHandler("test", project_handlers.test_command))
